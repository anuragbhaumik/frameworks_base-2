...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void tick(StatusBarNotification n, boolean firstTime, boolean isMusic,
        ...
        if ((!isMusic ? (n.getNotification().tickerText != null) : (metaMediaData != null))
                && mPhoneStatusBarWindow != null && mPhoneStatusBarWindow.getWindowToken() != null) {
    ...
    public void updateTileStyle() {
        ...
        derpUtils.updateTileStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), qsTileStyle);
    }

    // Unload all qs tile styles back to stock
    public void stockTileStyle() {
        derpUtils.stockTileStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId());
    }
    ...
    public void onTuningChanged(String key, String newValue) {
        switch (key) {
            ...
            case STATUS_BAR_TICKER_ANIMATION_MODE:
                ...
                break;
            case STATUS_BAR_TICKER_TICK_DURATION:
                mTickerTickDuration =
